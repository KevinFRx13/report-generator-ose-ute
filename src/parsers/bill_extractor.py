...
ESQUEMA (todos los valores numéricos como STRING, tal como aparecen en la factura):
{
  ...
  "consumo_punta_kwh": "string — kWh TOTALES en Punta. Para tarifas horarias: leer de la tabla de lecturas (fila 'Energía Punta', columna 'Total de Medida'). El DETALLE DE FACTURACIÓN puede tener múltiples líneas de Punta ('días hábiles' y 'NO hábiles') — NO sumar esas líneas, usar el valor de la tabla de lecturas. Si tarifa simple, usar '0'.",
  "consumo_valle_kwh": "string — kWh en Valle (tabla de lecturas, fila 'Energía Valle', columna 'Total de Medida'). Si tarifa simple, usar '0'.",
  "consumo_llano_kwh": "string — kWh en Llano (tabla de lecturas, fila 'Energía Llano', columna 'Total de Medida'). Si tarifa simple, usar '0'.",
